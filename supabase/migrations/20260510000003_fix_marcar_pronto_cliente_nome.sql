-- ============================================================
-- FIX: marcar_pedido_pronto — pc.cliente_nome não existe
-- ============================================================
-- pedidos_comerciais tem cliente_id (FK), não cliente_nome.
-- O nome do cliente está na tabela clientes.nome.
-- Corrige o FOR loop fazendo JOIN com clientes.
-- ============================================================
