...
-- run_scheduled_backup() e seu agendamento via pg_cron foram movidos para
-- 20260040000000_correcoes_pendentes.sql — esta migration já tinha sido
-- aplicada no banco antes dessa correção existir, então editar este arquivo
-- não bastava (o Supabase CLI rastreia migrations já feitas pelo NOME do
-- arquivo, não pelo conteúdo).
