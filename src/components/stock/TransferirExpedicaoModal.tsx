...
import {
  ArrowRight, Package, Tag, ChevronDown, CheckCircle2, Minus, Plus, Truck,
} from "lucide-react";
import type { StockItem, LoteSummary } from "@/hooks/useStock";
import { fetchLotesSummary, transferToExpedicao } from "@/hooks/useStock";
...
export function TransferirExpedicaoModal({ item, open, onClose, onSuccess }: Props) {
  ...
  const afterIntermediariaQty = item.quantity - resolvedQty;
        ...
        <div className="px-5 pb-5 space-y-4">
          ...
          <div className="flex gap-2 pt-1">
            ...
            <Button
              ...
              disabled={loading || resolvedQty < 1 || !lote || afterIntermediariaQty < 0}
            >
              {loading
