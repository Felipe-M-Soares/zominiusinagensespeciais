...
const hasFilters = search || filters.material || filters.classification || filters.sterile || filters.single_use || filters.exocad || activeLetter;
  ...
  <div className="space-y-3">
    ...
    <div className="flex gap-2">
      <div className="relative flex-1">
        ...
        <Input
          placeholder="Pesquisar modelo, referência, UDI-DI, código..."
          value={search}
          onChange={(e) => onSearchChange(e.target.value)}
          className="pl-10 h-10 sm:h-11 text-sm bg-card"
        />
      </div>
      <Button
