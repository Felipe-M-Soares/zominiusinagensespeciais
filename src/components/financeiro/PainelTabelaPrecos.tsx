...
import {
  AlertTriangle, CheckCircle2, ChevronDown, ChevronUp, Edit3,
  FileSpreadsheet, Loader2, Package, Percent, Printer, RefreshCw, Tag,
  Trash2, TrendingDown, X, Zap,
} from "lucide-react";
...
export function PainelTabelaPrecos({ modoTeste }: { modoTeste: boolean }) {
