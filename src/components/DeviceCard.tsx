...
export function DeviceCard({ device, onClick }: Props) {
  ...
  <div
    role="button"
    tabIndex={0}
    className="w-full text-left group relative rounded-xl bg-card overflow-hidden transition-all duration-300 hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer"
    style={{
      boxShadow:
