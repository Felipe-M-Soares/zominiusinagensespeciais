...
export function QualidadeProducaoPanel() {
  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-200">
      ...
      <div className="flex gap-2">
        <div className="relative flex-1"><SearchInputWithBarcode value={search} onChange={setSearch} onSearch={setSearch} placeholder="Bipe o código ou busque refugo..." height="h-9"/></div>
